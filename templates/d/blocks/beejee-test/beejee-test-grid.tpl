<div class="beejee-test-grid js-beejee-test-grid">
    ...
    <a href="{{ statusLink }}" class="beejee-test-grid-el beejee-test-grid-el--center beejee-test-grid-el--title beejee-test-grid-el--title-sortable js-beejee-test-grid-el-title
        {% if sortParam == "status" %}
            {% if sortDirection == "ASC" %}
                beejee-test-grid-el--sort-asc
            {% else %}
    ...
    {% for task in tasks %}
        {% include "d/blocks/beejee-test/beejee-test-grid-el.tpl" %}
    {% endfor %}
    {% include "d/blocks/beejee-test/beejee-test-grid-el-fill.tpl" %}
</div>